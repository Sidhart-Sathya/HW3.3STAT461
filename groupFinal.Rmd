...
cricketPHPairs <- emmeans::emmeans(
object = cricketModel, # Your aov/lm object
specs = pairwise ~ Type, # Creates all pairs of the levels of the factor listed
...
knitr::kable(
x = cricketPHPairs$contrasts, # Grab the appropriate sub-object
digits = 3,
